...
var tourismPlaceList = [
  TourismPlace(
    ...
    imageAssets: 'images/farm-house.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    imageAssets: 'images/bosscha.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
    imageAssets: 'images/jalan-asia-afrika.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 3000',
    imageAssets: 'images/stone-garden.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Free',
    imageAssets: 'images/taman-film.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 3000',
    imageAssets: 'images/museum-geologi.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    ticketPrice: 'Rp 20000',
    imageAssets: 'images/floating-market.png',
    imageUrls: [
  ...
  TourismPlace(
    ...
    imageAssets: 'images/kawah-putih.jpg',
    imageUrls: [
  ...
  TourismPlace(
    ...
    openTime: '24 hours',
    ticketPrice: 'Rp 20000',
    imageAssets: 'images/ranca-upas.jpg',
    imageUrls: [
